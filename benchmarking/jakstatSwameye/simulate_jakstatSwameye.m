% simulate_jakstatSwameye.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%   this routine was generated using AMICI commit 3d65d89ebd2182d5ff0fe56857cee500274b008a in branch master in repo https://github.com/ICB-DCM/AMICI.
%
% USAGE:
% ======
% [...] = simulate_jakstatSwameye(tout,theta)
% [...] = simulate_jakstatSwameye(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_jakstatSwameye(...)
%
% INPUTS:
% =======
...
function varargout = simulate_jakstatSwameye(varargin)
...
if(max(options_ami.sens_ind)>16)
...
sol = ami_jakstatSwameye(tout,theta(1:16),kappa(1:3),options_ami,plist,pbar,xscale,init,data);
if(options_ami.sensi==1)
