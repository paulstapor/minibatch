function [model] = jakstatSwameye_syms()
...
model.sym.p = [p1,p2,p3,p4,sp1,sp2,sp3,sp4,sp5,offset_tSTAT,offset_pSTAT,scale_tSTAT,scale_pSTAT,sigma_pSTAT,sigma_tSTAT,sigma_pEpoR];
model.param = 'log10';
model.sym.k = [Omega_cyt,Omega_nuc,init_STAT];
